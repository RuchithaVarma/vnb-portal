...
const toppers = [
  {
    ...
    story:
      "Brilliant Roots helped me achieve my dream with their excellent faculty and structured approach.",
  },
  {
    name: "Priya Patel",
    rank: "AIR 3",
    ...
    story:
      "The regular tests and doubt clearing sessions were game-changers for my NEET preparation.",
  },
  {
    name: "Rahul Kumar",
    rank: "99.8%ile",
    ...
    story:
      "I improved my scores significantly with Brilliant Roots' personalized attention.",
  },
  {
    name: "Sneha Reddy",
    rank: "State Topper",
    ...
    story:
      "The teachers made complex topics easy to understand and always motivated me.",
  },
];
...
const testimonials = [
  {
    ...
    score: "99.8%ile",
    quote:
      "Brilliant Roots's live classes and personalized doubt solving helped me crack JEE. The teachers are amazing and always available to help!",
    color: "from-blue-400 to-cyan-500",
  ...
  },
  {
    ...
    score: "720/720",
    quote:
      "The structured curriculum and regular tests kept me on track. I'm grateful to my Brilliant Roots teachers for their constant support.",
  ...
  },
  {
    ...
    score: "98.4%",
    quote:
      "I improved from 75% to 98% with Brilliant Roots! The interactive classes made learning fun and the study materials were excellent.",
    color: "from-green-400 to-teal-500",
  ...
  },
  {
    ...
    score: "96.8%",
    quote:
      "Brilliant Roots helped me build strong fundamentals. The teachers explain concepts so clearly that even difficult topics become easy!",
  ...
  },
  {
    ...
    score: "1st Place",
    quote:
      "The coding course at Brilliant Roots sparked my interest in programming. Now I'm building my own apps!",
...
const announcements = [
  {
    ...
    message:
      "JEE 2026 crash course starting from 15th April. Limited seats available!",
    date: "2024-03-25",
    type: "info",
    priority: "high",
  },
  {
    ...
    message:
      "JEE Main Mock Test results are out. Check your performance dashboard.",
    date: "2024-03-24",
    type: "update",
    priority: "medium",
  },
  {
    ...
    message:
      "Classes will remain suspended on 29th March due to Holi festival.",
    date: "2024-03-23",
    type: "holiday",
    priority: "low",
  },
