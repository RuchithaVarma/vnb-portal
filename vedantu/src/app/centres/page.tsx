...
import { Search, MapPin, Phone, Mail, Clock, Star, Users, Building, Navigation, Calendar, Award } from 'lucide-react';
...
export default function OfflineCentresPage() {
  ...
  const centres = [
    {
      id: 1,
      name: 'Vedantu Learning Centre - Andheri',
      city: 'mumbai',
      address: 'Shop No. 12, 3rd Floor, Infinity Mall, Andheri West, Mumbai - 400053',
      phone: '+91 98765 43210',
      email: 'andheri@vedantu.com',
      rating: 4.8,
      students: 1250,
      established: '2020',
      features: ['Smart Classrooms', 'Library', 'Science Lab', 'Counseling Room'],
    ...
    {
      id: 2,
      name: 'Vedantu Learning Centre - Connaught Place',
      city: 'delhi',
      address: 'A-Block, Connaught Place, New Delhi - 110001',
      phone: '+91 98765 43211',
      email: 'cp@vedantu.com',
      rating: 4.9,
      students: 1890,
      established: '2019',
      features: ['Digital Classrooms', 'Computer Lab', 'Study Lounge', 'Parking'],
    ...
    {
      id: 3,
      name: 'Vedantu Learning Centre - Koramangala',
      city: 'bangalore',
      address: '5th Block, Koramangala, Bangalore - 560095',
      phone: '+91 98765 43212',
      email: 'koramangala@vedantu.com',
      rating: 4.7,
      students: 980,
      established: '2021',
      features: ['Modern Classrooms', 'Library', 'Physics Lab', 'Chemistry Lab'],
    ...
    {
      id: 4,
      name: 'Vedantu Learning Centre - Madhapur',
      city: 'hyderabad',
      address: 'Hitech City, Madhapur, Hyderabad - 500081',
      phone: '+91 98765 43213',
      email: 'madhapur@vedantu.com',
      rating: 4.8,
      students: 1450,
      established: '2020',
    ...
    {
      id: 5,
      name: 'Vedantu Learning Centre - T. Nagar',
      city: 'chennai',
      address: 'Usman Road, T. Nagar, Chennai - 600017',
      phone: '+91 98765 43214',
      email: 'tnagar@vedantu.com',
      rating: 4.6,
      students: 780,
      established: '2021',
    ...
    {
      id: 6,
      name: 'Vedantu Learning Centre - Salt Lake',
      city: 'kolkata',
      address: 'Sector 1, Salt Lake City, Kolkata - 700064',
      phone: '+91 98765 43215',
      email: 'saltlake@vedantu.com',
      rating: 4.7,
      students: 920,
      established: '2020',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-3xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h1 className="text-4xl md:text-5xl font-bold">
                Vedantu Offline Centres
              </h1>
            </div>
            <p className="text-xl mb-8 text-white/90">
              Experience the perfect blend of online and offline learning. Visit our state-of-the-art centres across India.
            </p>
      ...
      <section className="bg-white border-b sticky top-16 z-40">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-4 py-4 overflow-x-auto">
            <span className="text-sm font-medium text-gray-700 whitespace-nowrap">Filter by City:</span>
            {cities.map((city) => (
              <button
                key={city.id}
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-2xl font-bold text-gray-900">
            ...
            <span className="text-gray-500 font-normal ml-2">({filteredCentres.length} centres)</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredCentres.map((centre) => (
            <div key={centre.id} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300">
              {/* Centre Image */}
              <div className="h-48 bg-gradient-to-br from-green-400 to-teal-400 relative">
                ...
                <div className="absolute top-4 right-4">
                  <div className="flex items-center gap-1 bg-white/90 backdrop-blur-sm px-2 py-1 rounded-full">
                    ...
                    <span className="text-xs font-semibold">{centre.rating}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="space-y-3 mb-4">
                  <div className="flex items-start gap-2">
                    ...
                    <span className="text-sm text-gray-600 line-clamp-2">{centre.address}</span>
                  </div>
                  <div className="flex items-center gap-4 text-sm text-gray-600">
                    ...
                    <div className="flex items-center gap-1">
                      <Mail size={16} />
                      <span className="text-xs">{centre.email.split('@')[0]}@...</span>
                    </div>
                  </div>
                  <div className="flex items-center gap-1">
                    <Clock size={16} className="text-gray-400" />
                    <span className="text-sm text-gray-600">{centre.timings}</span>
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {centre.features.slice(0, 3).map((feature, index) => (
                      <span key={index} className="text-xs px-2 py-1 bg-green-50 text-green-600 rounded-full">
                        {feature}
                      </span>
                    ))}
                ...
                {/* Courses */}
                <div className="mb-4">
                  <h4 className="text-sm font-semibold text-gray-900 mb-2">Courses Available</h4>
                  <div className="flex flex-wrap gap-2">
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Why Choose Vedantu Offline Centres?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Learn from experienced teachers who provide personalized attention</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">State-of-the-art classrooms, labs, and learning facilities</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <Users className="text-blue-600" size={32} />
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Hybrid Learning</h3>
              <p className="text-gray-600">Best of both online and offline learning experiences</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-r from-green-600 to-teal-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Visit Your Nearest Vedantu Centre Today!</h2>
          <p className="text-xl mb-8 text-white/90">Experience the future of education with our hybrid learning model</p>
