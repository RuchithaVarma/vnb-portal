...
const INITIAL_ANNOUNCEMENTS: Announcement[] = [
  {
    ...
    content:
      "Register 3 new sales this week to unlock a 2% bonus incentive on total portfolio value.",
    type: "info",
    date: "26 Apr, 2024",
    targetPartners: ["all"],
  },
  {
    ...
    content:
      "We have upgraded the dashboard to include real-time payment tracking and automated commission calculations.",
    type: "success",
    date: "25 Apr, 2024",
    targetPartners: ["all"],
  },
